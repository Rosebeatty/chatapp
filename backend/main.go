...
func setupRoutes() {
	...
	router.HandleFunc("/getContacts/{username}", func(w http.ResponseWriter, r *http.Request) {
		routes.GetContacts(w, r)
	})
	router.HandleFunc("/getUser/{username}", func(w http.ResponseWriter, r *http.Request) {
		routes.GetUser(w, r)
	})
	router.HandleFunc("/upload/{username}", func(w http.ResponseWriter, r *http.Request) {
		routes.UploadProfilePic(w, r)
	})
	router.HandleFunc("/upload", func(w http.ResponseWriter, r *http.Request) {
		routes.UploadFile(w, r)
	})
	router.HandleFunc("/updateUser/{username}/{description}/{status}", func(w http.ResponseWriter, r *http.Request) {
		routes.UpdateUser(w, r)
	})
	router.HandleFunc("/addFriend/{username}/{friend}", func(w http.ResponseWriter, r *http.Request) {
		routes.AddFriend(w, r)
	})
	router.HandleFunc("/deleteFriend/{username}/{friend}", func(w http.ResponseWriter, r *http.Request) {
		routes.DeleteFriend(w, r)
	})
	router.HandleFunc("/deleteAccount/{username}", func(w http.ResponseWriter, r *http.Request) {
		routes.DeleteAccount(w, r)
	})
	router.HandleFunc("/saveMessage/{username}", func(w http.ResponseWriter, r *http.Request) {
		routes.SaveMessage(w, r)
	})
	router.HandleFunc("/deleteMessage/{username}", func(w http.ResponseWriter, r *http.Request) {
		routes.DeleteMessage(w, r)
	})
